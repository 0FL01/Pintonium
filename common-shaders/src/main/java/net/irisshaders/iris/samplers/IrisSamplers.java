...
public class IrisSamplers {
	...
	public static boolean addDisabledShadowSamplers(SamplerHolder samplers, MCAbstractTexture whitePixel) {
		boolean usesShadows = samplers.addDynamicSampler(whitePixel::getId, "shadowtex0", "shadow", "watershadow");
		usesShadows |= samplers.addDynamicSampler(whitePixel::getId, "shadowtex1");
