...
public abstract class CommonIrisRenderingPipeline implements WorldRenderingPipeline, IrisRenderingPipeline, ShaderRenderingPipeline, RenderTargetStateListener {
    ...
    private boolean hasUsableShadowRenderer() {
        return shadowRenderTargets != null && shadowRenderer != null;
    }
    ...
    private void addWorldShadowImages(ImageHolder images) {
        if (hasUsableShadowRenderer()) {
            IrisImages.addShadowColorImages(images, shadowRenderTargets, null);
        }
    }
    ...
    public CommonIrisRenderingPipeline(ProgramSet programSet) {
        ...
        IntFunction<ProgramSamplers> createTerrainSamplers = (programId) -> {
            ...
            if (IrisSamplers.hasShadowSamplers(customTextureSamplerInterceptor)) {
                addWorldShadowSamplers(customTextureSamplerInterceptor);
            }
        ...
        this.sodiumTerrainPipeline = new SodiumTerrainPipeline(
                ...
                hasUsableShadowRenderer() ? createShadowTerrainSamplers : null,
                createTerrainImages,
                createShadowTerrainImages,
                renderTargets,
                flippedAfterPrepare,
                flippedAfterTranslucent,
                hasUsableShadowRenderer() ? shadowRenderTargets.createShadowFramebuffer(
                        ImmutableSet.of(),
