...
public class IrisLodRenderProgram {
	...
	private IrisLodRenderProgram(String name, boolean isShadowPass, boolean translucent, BlendModeOverride override, BufferBlendOverride[] bufferBlendOverrides, String vertex, String tessControl, String tessEval, String geometry, String fragment, CustomUniforms customUniforms, CommonIrisRenderingPipeline pipeline) {
	...
	public static IrisLodRenderProgram createProgram(String name, boolean isShadowPass, boolean translucent, ProgramSource source, CustomUniforms uniforms, CommonIrisRenderingPipeline pipeline) {
	...
	public void fillUniformData(Matrix4fc projection, Matrix4fc modelView, int worldYOffset, float partialTicks) {
		...
		// Fog/Clip Uniforms
		setUniform(clipDistanceUniform, DhApi.Delayed.renderProxy.getNearClipPlaneDistanceInBlocks(partialTicks));
